...
if(typeof(otp.config.locale) == "undefined" || otp.config.locale == null) otp.config.locale = otp.locale.Portuguese;
...
otp.config_defaults = {
    ...
    planner : {
        ...
        options        : {
            ...
            showLayerSwitcher     : false,   // turn on/off OpenLayers layer switcher when more than 1 basemap exists (see map.baseLayer below)
    ...
    map : {
        ...
        defaultExtent: new OpenLayers.Bounds(-8.4577, 40.2282, -8.3833, 40.1768),
    ...
    logo: "http://www.smtuc.pt/imagens/logo_entrada.gif",
